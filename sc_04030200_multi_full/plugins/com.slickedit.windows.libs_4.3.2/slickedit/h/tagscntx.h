 ...
 */
EXTERN_C
int VSAPI tag_set_context_type_signature(VSPSZ tag_name, VSPSZ type_name, bool case_sensitive VSDEFAULT(false));
 ...
 */
EXTERN_C
int VSAPI tag_clear_context(/*VSHREFVAR file_name*/);
 ...
 */
EXTERN_C
int VSAPI tag_set_local_type_signature(VSPSZ local_name, VSPSZ type_name, bool case_sensitive VSDEFAULT(false));

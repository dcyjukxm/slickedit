...
_str debug_get_mouse_expr(int &cursor_x, int &width, _str *streamMarkerMessage=null)
{
   ...
   */
   ...
   if (select_active2() && _in_selection() && !(isEclipsePlugin() && _eclipse_debug_active())) {
      ...
      _UpdateLocals(true);
      p_col=idexp_info.lastidstart_col;cursor_x=p_cursor_x;
      ...
      if (isEclipsePlugin() && _eclipse_debug_active() && _LanguageInheritsFrom("cob")) {
         expr=idexp_info.lastid;
      } else {

 ...
 * @example 
 * <pre> 
 *    setup_info := 'MN=Modula,TABS=+3,MA=1 74 1,KEYTAB=mod-keys,WW=1,IWT=0,ST=0,';
 *    compile_info := '';
 ...
 *                         indent with tabs setting, and show tabs style.
 *                         See example above.
...
/*
   Disable truncation line feature for all SlickEdit languages
 */
int _e_is_truncation_supported()       { return(0); }
int _grep_is_truncation_supported()    { return(0); }
int _fileman_is_truncation_supported() { return(0); }
int _process_is_truncation_supported() { return(0); }
int _vpj_is_truncation_supported()     { return(0); }
int _vlx_is_truncation_supported()     { return(0); }
int _vsm_is_truncation_supported()     { return(0); }
int _tagdoc_is_truncation_supported()  { return(0); }

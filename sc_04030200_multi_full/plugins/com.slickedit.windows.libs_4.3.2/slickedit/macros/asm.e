...
defload()
{
   ...
   setup_info='MN='MASM_MODE_NAME',TABS=+8,MA=1 74 1,':+
              'KEYTAB=default-keys,WW=1,IWT=0,ST=0,IN=1,':+
   ...
   setup_info='MN='S390_MODE_NAME',TABS=10 16 36 72 73,MA=1 74 1,':+
              'KEYTAB='S390_LANGUAGE_ID'-keys,WW=1,IWT=0,ST=0,IN=2,':+
...
#define ASM_COMMON_LIST ' proc macro equ .equ db dw dd ds struc label':+ \

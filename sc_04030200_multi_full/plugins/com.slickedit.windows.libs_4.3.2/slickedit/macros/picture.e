...
/*
    form_wid.p_user2     Indicates the button wid that has already been executed
                         since last time mouse pointer was inside form.
*/
...
void _BBTimerCallback()
{
   ...
   if( form_wid.p_user2=="" ||
      (CurrentWid == wid && form_wid.p_user2 != CurrentWid) ) {

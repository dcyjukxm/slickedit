...
static boolean MergeInConflictRegion(int &conflict_number=0,boolean IncludeChanges=false)
{
   ...
   MERGE_PIC_INFO PicIndexes[]=GetDialogInfo('PicIndexes');
                ...
                boolean CallerSaves)
{
   ...
   SetDialogInfo('BaseOrigReadOnly',BaseOrigReadOnly);
   SetDialogInfo('Rev1OrigReadOnly',Rev1OrigReadOnly);
   SetDialogInfo('Rev2OrigReadOnly',Rev2OrigReadOnly);

   ctloutput.p_AllowSave=1;

   SetDialogInfo('BaseLineMatches',BaseLineMatches);
   ...
   SetDialogInfo('MergeNumConflicts',MergeNumConflicts());
   SetDialogInfo('PicIndexes',PicIndexes);

   boolean ConflictClearedInOutput[];
   for (i=0;i<=MergeNumConflicts();++i) {
      ConflictClearedInOutput[i]=false;
   }
   SetDialogInfo('ConflictClearedInOutput',ConflictClearedInOutput);
   SetDialogInfo('CallerSaves',CallerSaves);

   ctlrev1.merge_next_conflict();
...
static void CopyConflictToOutput(int ConflictNumber,boolean ClearOutputFirst=true)
{
   ...
   boolean ConflictClearedInOutput[]=GetDialogInfo('ConflictClearedInOutput');
   if (!ClearOutputFirst) {
...
static void FindLinesBR2(int rev1_line,int &base_line,int &rev2_line)
{
   ...
   _str BaseLineMatches[]=GetDialogInfo('BaseLineMatches');
...
int ctlclose.lbutton_up()
{
   ...
   boolean caller_saves=GetDialogInfo("CallerSaves");
   ...
   ctlbase.RestoreReadOnly(GetDialogInfo('BaseOrigReadOnly'));
   ctlrev1.RestoreReadOnly(GetDialogInfo('Rev1OrigReadOnly'));
   ctlrev2.RestoreReadOnly(GetDialogInfo('Rev2OrigReadOnly'));
...
_command void merge_next_conflict()
{

...
#define  XW_DEFAULTSYMBOLTRANSALIASFILE 'symboltrans.als'
...
{
   _str selected = ctl_XW_tag_list._lbmulti_select_result();
   selected = strip(selected);
   selected = strip(selected, 'B', '"');
   //say('|'ctl_XW_tag_list._lbmulti_select_result()'|'selected'|'currentTag()'|');
...
void ctl_XW_tag_list_on_change() 
{
   ...
   layoutupdate();
   //tempModified = XW_schemes:[currentScheme()].modified = tempModified;
   return;
}
...
{
   boolean endTag = (ctl_XW_endTag_check.p_value == 1);
   int status = ctl_XW_tag_list._lbfind_selected(true);
   while (!status) {
      XW_schemes:[currentScheme()].tagSettings:[currentTag()].generalSettings.hasEndTag = endTag;
...
{
   boolean insertEndTag = (ctl_XW_insertEndTag_check.p_value == 1);
   int status = ctl_XW_tag_list._lbfind_selected(true);
   while (!status) {
      XW_schemes:[currentScheme()].tagSettings:[currentTag()].generalSettings.insertEndTags = insertEndTag;
      status = ctl_XW_tag_list._lbfind_selected(false);
   }
   layoutupdate();
}
...
{
   boolean caseSenitive = (ctl_XW_caseSensitive.p_value == 1);
   _str currentSchemeName = currentScheme();
   XW_schemes:[currentSchemeName].caseSensitive = caseSenitive;
   layoutupdate();
...
void ctl_XW_wrapTagContent_radio.lbutton_up() 
{
   int status = ctl_XW_tag_list._lbfind_selected(true);
   while (!status) {
      XW_schemes:[currentScheme()].tagSettings:[currentTag()].contentWrapSettings.wrapMode = XW_CWS_WRAP;
      status = ctl_XW_tag_list._lbfind_selected(false);
   }
   layoutupdate();
}
void ctl_XW_noWrap_radio.lbutton_up() 
{
   int status = ctl_XW_tag_list._lbfind_selected(true);
   while (!status) {
      XW_schemes:[currentScheme()].tagSettings:[currentTag()].contentWrapSettings.wrapMode = XW_CWS_IGNORE;
      status = ctl_XW_tag_list._lbfind_selected(false);
   }
   layoutupdate();
}
void ctl_XW_preserveContent_check_radio.lbutton_up() 
{
   int status = ctl_XW_tag_list._lbfind_selected(true);
   while (!status) {
      XW_schemes:[currentScheme()].tagSettings:[currentTag()].contentWrapSettings.wrapMode = XW_CWS_PRESERVE;
      status = ctl_XW_tag_list._lbfind_selected(false);
   }
   layoutupdate();
}
...
void ctl_XW_fixedWidth_radio.lbutton_up() 
{
   int status = ctl_XW_tag_list._lbfind_selected(true);
   while (!status) {
      XW_schemes:[currentScheme()].tagSettings:[currentTag()].contentWrapSettings.wrapMethod = XW_CWS_FIXEDWIDTH;
      status = ctl_XW_tag_list._lbfind_selected(false);
   }
   layoutupdate();
}
void ctl_XW_autoWidth_radio.lbutton_up() 
{
   int status = ctl_XW_tag_list._lbfind_selected(true);
   while (!status) {
      XW_schemes:[currentScheme()].tagSettings:[currentTag()].contentWrapSettings.wrapMethod = XW_CWS_AUTOWIDTH;
      status = ctl_XW_tag_list._lbfind_selected(false);
   }
   layoutupdate();
}
void ctl_XW_fixedRightMargin_radio.lbutton_up() 
{
   int status = ctl_XW_tag_list._lbfind_selected(true);
   while (!status) {
      XW_schemes:[currentScheme()].tagSettings:[currentTag()].contentWrapSettings.wrapMethod = XW_CWS_FIXEDRIGHT;
      status = ctl_XW_tag_list._lbfind_selected(false);
   }
   layoutupdate();
}
void ctl_XW_parentRightMargin_radio.lbutton_up() 
{
   int status = ctl_XW_tag_list._lbfind_selected(true);
   while (!status) {
      XW_schemes:[currentScheme()].tagSettings:[currentTag()].contentWrapSettings.wrapMethod = XW_CWS_PARENT;
      status = ctl_XW_tag_list._lbfind_selected(false);
   }
   layoutupdate();
}
...
void ctl_XW_fixedWidthMax_check.lbutton_up() 
{
   int status = ctl_XW_tag_list._lbfind_selected(true);
   while (!status) {
      XW_schemes:[currentScheme()].tagSettings:[currentTag()].contentWrapSettings.useFixedWidthMRC = (ctl_XW_fixedWidthMax_check.p_value == 1);
      status = ctl_XW_tag_list._lbfind_selected(false);
   }
   layoutupdate();
}
void ctl_XW_autoWidthMax_check.lbutton_up() 
{
   int status = ctl_XW_tag_list._lbfind_selected(true);
   while (!status) {
      XW_schemes:[currentScheme()].tagSettings:[currentTag()].contentWrapSettings.useAutoWidthMRC = (ctl_XW_autoWidthMax_check.p_value == 1);
      status = ctl_XW_tag_list._lbfind_selected(false);
   }
   layoutupdate();
}
void ctl_XW_includeTags_check.lbutton_up() 
{
   int status = ctl_XW_tag_list._lbfind_selected(true);
   while (!status) {
      XW_schemes:[currentScheme()].tagSettings:[currentTag()].contentWrapSettings.includeTags = (ctl_XW_includeTags_check.p_value == 1);
      status = ctl_XW_tag_list._lbfind_selected(false);
   }
   layoutupdate();
}
void ctl_XW_preserveContent_check.lbutton_up() 
{
   int status = ctl_XW_tag_list._lbfind_selected(true);
   while (!status) {
      XW_schemes:[currentScheme()].tagSettings:[currentTag()].contentWrapSettings.preserveWidth = (ctl_XW_preserveContent_check.p_value == 1);
      status = ctl_XW_tag_list._lbfind_selected(false);
   }
   layoutupdate();
}
...
{
   int value = 1;
   if (isnumber(ctl_XW_fixedWidthCol_text.p_text)) {
      value = (int)ctl_XW_fixedWidthCol_text.p_text;
   }
   if (value < 1) {
      value = 1;
      ctl_XW_fixedWidthCol_text.p_text = 1;
   }
   int status = ctl_XW_tag_list._lbfind_selected(true);
   while (!status) {
      XW_schemes:[currentScheme()].tagSettings:[currentTag()].contentWrapSettings.fixedWidthCol = value;
      status = ctl_XW_tag_list._lbfind_selected(false);
   }
   layoutupdate();
}
...
{
   int value = 1;
   if (isnumber(ctl_XW_fixedWidthMRC_text.p_text)) {
      value = (int)ctl_XW_fixedWidthMRC_text.p_text;
   }
   if (value < 1) {
      value = 1;
      ctl_XW_fixedWidthMRC_text.p_text = 1;
   }
   int status = ctl_XW_tag_list._lbfind_selected(true);
   while (!status) {
      XW_schemes:[currentScheme()].tagSettings:[currentTag()].contentWrapSettings.fixedWidthMRC = value;
      status = ctl_XW_tag_list._lbfind_selected(false);
   }
   layoutupdate();
}
...
{
   int value = 1;
   if (isnumber(ctl_XW_autoWidthMRC_text.p_text)) {
      value = (int)ctl_XW_autoWidthMRC_text.p_text;
   }
   if (value < 1) {
      value = 1;
      ctl_XW_autoWidthMRC_text.p_text = 1;
   }
   int status = ctl_XW_tag_list._lbfind_selected(true);
   while (!status) {
      XW_schemes:[currentScheme()].tagSettings:[currentTag()].contentWrapSettings.autoWidthMRC = value;
      status = ctl_XW_tag_list._lbfind_selected(false);
   }
   layoutupdate();
}
...
{
   int value = 1;
   if (isnumber(ctl_XW_fixedRightCol_text.p_text)) {
      value = (int)ctl_XW_fixedRightCol_text.p_text;
   }
   if (value < 1) {
      value = 1;
      ctl_XW_fixedRightCol_text.p_text = 1;
   }
   int status = ctl_XW_tag_list._lbfind_selected(true);
   while (!status) {
      XW_schemes:[currentScheme()].tagSettings:[currentTag()].contentWrapSettings.fixedRightCol = value;
      status = ctl_XW_tag_list._lbfind_selected(false);
   }
   layoutupdate();
}
void ctl_XW_startTagSeparate_check.lbutton_up() 
{
   int status = ctl_XW_tag_list._lbfind_selected(true);
   while (!status) {
      XW_schemes:[currentScheme()].tagSettings:[currentTag()].tagLayoutSettings.separateStartTag = (ctl_XW_startTagSeparate_check.p_value == 1);
      status = ctl_XW_tag_list._lbfind_selected(false);
   }
   layoutupdate();
}
void ctl_XW_endTagSeparate_check.lbutton_up() 
{
   int status = ctl_XW_tag_list._lbfind_selected(true);
   while (!status) {
      XW_schemes:[currentScheme()].tagSettings:[currentTag()].tagLayoutSettings.separateEndTag = (ctl_XW_endTagSeparate_check.p_value == 1);
      status = ctl_XW_tag_list._lbfind_selected(false);
   }
   layoutupdate();
}
void ctl_XW_TLSmatchExt_radio.lbutton_up() 
{
   int status = ctl_XW_tag_list._lbfind_selected(true);
   while (!status) {
      XW_schemes:[currentScheme()].tagSettings:[currentTag()].tagLayoutSettings.indentMethod = XW_TLS_MATCHEXT;
      status = ctl_XW_tag_list._lbfind_selected(false);
   }
   layoutupdate();
}
void ctl_XW_TLSindent_radio.lbutton_up() 
{
   int status = ctl_XW_tag_list._lbfind_selected(true);
   while (!status) {
      XW_schemes:[currentScheme()].tagSettings:[currentTag()].tagLayoutSettings.indentMethod = XW_TLS_INDENT;
      status = ctl_XW_tag_list._lbfind_selected(false);
   }
   layoutupdate();
}
...
{
   int status = ctl_XW_tag_list._lbfind_selected(true);
   int newValue = (ctl_XW_check_IndentFromClose.p_value == 1) ? XW_TLS_AFTERCLOSING : XW_TLS_FROMOPENING;
   while (!status) {
      XW_schemes:[currentScheme()].tagSettings:[currentTag()].tagLayoutSettings.indentFrom = newValue;
      status = ctl_XW_tag_list._lbfind_selected(false);
   }
   layoutupdate();
}
void ctl_XW_indentSpaces_text.on_change() 
{
   int status = ctl_XW_tag_list._lbfind_selected(true);
   int value = 0;
   if (isnumber(ctl_XW_indentSpaces_text.p_text)) {
      value = (int)ctl_XW_indentSpaces_text.p_text;
   }
   if (value < 0) {
      value = 0;
      ctl_XW_indentSpaces_text.p_text = 0;
   }
   while (!status) {
      XW_schemes:[currentScheme()].tagSettings:[currentTag()].tagLayoutSettings.indentSpaces = value;
      status = ctl_XW_tag_list._lbfind_selected(false);
   }
   layoutupdate();
}
void ctl_XW_lineBreaksBefore_text.on_change() 
{
   int status = ctl_XW_tag_list._lbfind_selected(true);
   int value = 0;
   if (isnumber(ctl_XW_lineBreaksBefore_text.p_text)) {
      value = (int)ctl_XW_lineBreaksBefore_text.p_text;
   }
   if (value < 0) {
      value = 0;
      ctl_XW_lineBreaksBefore_text.p_text = 0;
   }
   while (!status) {
      XW_schemes:[currentScheme()].tagSettings:[currentTag()].tagLayoutSettings.lineBreaksBefore = value;
      status = ctl_XW_tag_list._lbfind_selected(false);
   }
   layoutupdate();
}
void ctl_XW_lineBreaksAfter_text.on_change() 
{
   int status = ctl_XW_tag_list._lbfind_selected(true);
   int value = 0;
   if (isnumber(ctl_XW_lineBreaksAfter_text.p_text)) {
      value = (int)ctl_XW_lineBreaksAfter_text.p_text;
   }
   if (value < 0) {
      value = 0;
      ctl_XW_lineBreaksAfter_text.p_text = 0;
   }
   while (!status) {
      XW_schemes:[currentScheme()].tagSettings:[currentTag()].tagLayoutSettings.lineBreaksAfter = value;
      status = ctl_XW_tag_list._lbfind_selected(false);
   }
   layoutupdate();
}
...
static void updateTagMatchList(_str matchName) 
{
   ...
   if (matchName == XW_DEFAULT_MATCH_TAGNAME || matchName == "") {
      ...
      if (ctl_XW_matchTagName_combo._lbi_search('', matchName, 'E')){
         ctl_XW_matchTagName_combo._lbtop();
         ctl_XW_matchTagName_combo.p_text = XW_DEFAULT_MATCH_TAGNAME_DISPLAY;
      } else {
         ctl_XW_matchTagName_combo.p_text = matchName;
      }
   }
   ctl_XW_matchTagName_combo._lbselect_line();
}
...
static void loadSchemeNames() {
   ...
   if (p_active_form.p_name == '_XW_form_doc_options') { 
      if (XW_selectSchemeDB._lbsearch(_GetDialogInfoHt('currentBufferScheme'), 'E')){
         XW_selectSchemeDB._lbtop();
      }
   }
...
{  
   ...
   if (p_active_form.p_name != '_XW_form_doc_options') { 
      if (XW_selectSchemeDB._lbsearch(currentBufferScheme, 'E')){
         XW_selectSchemeDB._lbtop();
      }
      XW_selectSchemeDB._lbselect_line();
      XW_selectSchemeDB.p_text = XW_selectSchemeDB._lbget_seltext();
...
void autoSymbolTransEditor(_str lang) 
{
   ...
   typeless result=show('-modal -new _alias_editor_form', filename, false, '', SYMTRANS_ALIAS_FILE, lang);
   return;
}

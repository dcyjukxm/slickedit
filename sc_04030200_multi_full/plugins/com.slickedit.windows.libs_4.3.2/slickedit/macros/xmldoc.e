...
void ctlok.on_create()
{
   ...
   CURTREEINDEX='';
   int editorctl_wid=_form_parent();
   ctldescription1.p_buf_name=".xmldoc";
   ctldescription2.p_buf_name=".xmldoc";
   ctldescription3.p_buf_name=".xmldoc";
   ctlexample1._SetEditorLanguage('xmldoc');
   ctlexample1.apply_dtd_changes();
   ctlexample1.p_buf_name=".xmldoc";
   ctlexample2.p_buf_name=".xmldoc";
   ctlexample2._SetEditorLanguage('xmldoc');
   ctlexample2.apply_dtd_changes();
   ctlexample3.p_buf_name=".xmldoc";
   ctlexample3._SetEditorLanguage('xmldoc');
   ctlexample3.apply_dtd_changes();
   ctlparam3.p_buf_name=".xmldoc";
   ctlreturn3.p_buf_name=".xmldoc";
   _for_each_control(p_active_form,_setEditorControlMode,'H');
...
boolean def_c_xmldoc;  // Defaults to false
...
_command void xmldoc_editor(_str forceXMLDOC='') name_info(','VSARG2_REQUIRES_EDITORCTL)
{
   ...
   if (forceXMLDOC=='') {
      ...
      //say('orig_comment='orig_comment);
      //say('comment_flags='comment_flags);

                ...
                boolean modify1, boolean modify2)
{
   ...
   p_text=nls('<B>%s1</B> is a unicode file and <B>%s2</B> is not.<P><B>%s3</B> must be temporarily converted to a unicode file.<p>Select the current encoding of your file so it can be converted to Unicode.',encoded_filename,unencoded_filename,unencoded_filename);
   p_window_id=wid;

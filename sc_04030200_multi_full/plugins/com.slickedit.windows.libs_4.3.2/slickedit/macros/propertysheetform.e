...
int helpHandle = 0;                 // handle to our help label
   ...
   for (i := 0; i < psPtr -> getNumItems(); i++) {
      ...
      if (type == TMT_GROUP) {
         ...
         if (pg != null) {
            ...
            _ctl_property_sheet._TreeSetRowColor(rowID, 0, 12632256, F_INHERIT_FG_COLOR);

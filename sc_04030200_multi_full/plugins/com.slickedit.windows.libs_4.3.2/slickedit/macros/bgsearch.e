   ...
   if (bgs_prepare_view(cur_file,temp_view_id,prev_view_id,file_already_loaded)) {
      ...
      if (!found_one_status) {
         ...
         do {
            ...
            truncate=SearchResults.getSearchResultLine(line, pcol, FoundLen, bgm_mfflags);
...
_command void bgsearch()
{
   ...
   int mfflags=bgs_recv_int(search_state);
   search_state.filesonly=(mfflags&MFFIND_FILESONLY)!=0;

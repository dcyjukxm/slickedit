...
//#endif
  ...
  replace_def_data("def-language-cfscript",'MN=CFScript,TABS=+4,MA=1 74 1,KEYTAB=c-keys,WW=1,IWT=0,ST=0,IN=2,WC=A-Za-z0-9_$,LN=CFScript,CF=1,');
  replace_def_data("def-options-cfscript",'4 1 1 0 4 1 1');
  ExtensionSettings.setLangRefersTo('cfscript', 'cfscript');

  replace_def_data("def-language-phpscript",'MN=PHP,TABS=+4,MA=1 74 1,KEYTAB=c-keys,WW=1,IWT=0,ST=0,IN=2,WC=A-Za-z0-9_$,LN=PHP,CF=1,');
  ...
  replace_def_data("def-language-idl",'MN=IDL,TABS=+4,MA=1 74 1,KEYTAB=c-keys,WW=1,IWT=0,ST=0,IN=2,WC=A-Za-z0-9_$,LN=IDL,CF=1,');
  ...
  replace_def_data("def-language-tagdoc",'MN=SlickEdit Tag Docs,TABS=+3,MA=1 74 1,KEYTAB=c-keys,WW=1,IWT=0,ST=0,IN=2,WC=A-Za-z0-9_$,LN=VSTagDoc,CF=1,');
  replace_def_data("def-options-tagdoc",'3 1 1 0 4 1 1');
  ExtensionSettings.setLangRefersTo('tagdoc', 'tagdoc');

  replace_def_data("def-language-bat",'MN=Batch,TABS=+4,MA=1 74 1,KEYTAB=ext-keys,WW=1,IWT=0,ST=0,IN=2,WC=A-Za-z0-9_$,LN=Batch,CF=1,LNL=0,');
  ...
  replace_def_data("def-language-ini",'MN=INI,TABS=+4,MA=1 74 1,KEYTAB=ext-keys,WW=1,IWT=0,ST=0,IN=2,WC=A-Za-z0-9_$,LN=INI File,CF=1,LNL=0,');
  ...
  replace_def_data("def-language-conf",'MN=Config,TABS=+4,MA=1 74 1,KEYTAB=ext-keys,WW=1,IWT=0,ST=0,IN=2,WC=A-Za-z0-9_$,LN=Config File,CF=1,LNL=0,');
  ...
  replace_def_data("def-language-mak",'MN=Makefile,TABS=+8,MA=1 74 1,KEYTAB=ext-keys,WW=1,IWT=1,ST=0,IN=2,WC=A-Za-z0-9_$,LN=Makefile,CF=1,LNL=0,');
  ...
  replace_def_data("def-language-imakefile",'MN=Imakefile,TABS=+4,MA=1 74 1,KEYTAB=ext-keys,WW=1,IWT=0,ST=0,IN=2,WC=A-Za-z0-9_$,LN=Imakefile,CF=1,LNL=0,');
  replace_def_data("def-options-imakefile",'4 1 1 0 0 3 0');
  ExtensionSettings.setLangRefersTo('imakefile', 'imakefile');

  replace_def_data("def-language-fundamental","MN=Plain Text,TABS=+8,MA=1 74 1,KEYTAB=default-keys,WW=1,IWT=0,ST=0,IN=1,WC=A-Za-z0-9_'.$,LN=,CF=4,");
  ...
  replace_def_data("def-language-binary",'MN=Binary,TABS=+4,MA=1 74 1,KEYTAB=default-keys,WW=0,IWT=0,ST=0,IN=0,WC=A-Za-z0-9_$,LN=,CF=4,');
  ...
  replace_def_data("def-language-process",'MN=Process,TABS=+8,MA=1 74 1,KEYTAB=process-keys,WW=1,IWT=0,ST=0,IN=1,WC=A-Za-z0-9_$.!@#%^&()\-_=+[{\]},LN=,CF=4,');
  LanguageSettings.setMenuIfNoSelection('process', '_process_menu_default');

  replace_def_data("def-language-fileman",'MN=Fileman,TABS=+8,MA=1 74 1,KEYTAB=fileman-keys,WW=1,IWT=0,ST=0,IN=1,WC=A-Za-z0-9_$,LN=,CF=4,LNL=0,');

  // C/C++
  replace_def_data("def-language-c",'MN=C/C++,TABS=+4,MA=1 74 1,KEYTAB=c-keys,WW=1,IWT=0,ST=0,IN=2,WC=A-Za-z0-9_$,LN=cpp,CF=1,LNL=0,TL=-1');
  ...
  // Objective-C
  replace_def_data("def-language-m",'MN=Objective-C,TABS=+4,MA=1 74 1,KEYTAB=c-keys,WW=1,IWT=0,ST=0,IN=2,WC=A-Za-z0-9_$,LN=Objective-C,CF=1,LNL=0,TL=-1');
  ...
  // Applescript
  replace_def_data("def-language-applescript",'MN=Applescript,TABS=+4,MA=1 74 1,KEYTAB=c-keys,WW=1,IWT=0,ST=0,IN=2,WC=A-Za-z0-9_$,LN=Applescript,CF=1,LNL=0,TL=0,BNDS=,CAPS=0,SW=0,SOW=0');
  ...
  replace_def_data("def-language-cs",'MN=C#,TABS=+4,MA=1 74 1,KEYTAB=c-keys,WW=1,IWT=0,ST=0,IN=2,WC=A-Za-z0-9_@,LN=CSharp,CF=1,LNL=0,TL=-1');
  ...
  // Pascal
  replace_def_data("def-language-pas",'MN=Pascal,TABS=+4,MA=1 74 1,KEYTAB=pascal-keys,WW=1,IWT=0,ST=0,IN=2,WC=A-Za-z0-9_$,LN=pascal,CF=1,');
...
*/
  ...
  // Slick-C
  replace_def_data("def-language-e",'MN=Slick-C,TABS=+3,MA=1 74 1,KEYTAB=slick-keys,WW=1,IWT=0,ST=0,IN=2,WC=A-Za-z0-9_$,LN=Slick-C,CF=1,');
  replace_def_data("def-options-e","3 1 1 0 4 1 0");
  replace_def_data("def-encoding-e",'+ftext');
  ...
  // Java
  replace_def_data("def-language-java",'MN=Java,TABS=+8,MA=1 74 1,KEYTAB=java-keys,WW=1,IWT=0,ST=0,IN=2,WC=A-Za-z0-9_$,LN=Java,CF=1,');
  replace_def_data("def-options-java","4 1 1 0 4 1 1");
  ExtensionSettings.setLangRefersTo('java', 'java');
  LanguageSettings.setReferencedInLanguageIDs('java', "js");

  // J#
  replace_def_data("def-language-jsl",'MN=J#,TABS=+8,MA=1 74 1,KEYTAB=java-keys,WW=1,IWT=0,ST=0,IN=2,WC=A-Za-z0-9_$,LN=JSharp,CF=1,');
  ...
  // HTML
  replace_def_data("def-language-html",'MN=HTML,TABS=+4,MA=1 74 1,KEYTAB=html-keys,WW=1,IWT=0,ST=0,IN=2,WC=A-Za-z0-9_:$,LN=HTML,CF=1,');
  ...
  // CFML
  replace_def_data("def-language-cfml",'MN=CFML,TABS=+4,MA=1 74 1,KEYTAB=html-keys,WW=1,IWT=0,ST=0,IN=1,WC=A-Za-z0-9_:$,LN=CFML,CF=1,');
  ...
  // Bulletin Board Code
  replace_def_data("def-language-bbc",'MN=Bulletin Board Code,TABS=+4,MA=1 74 1,KEYTAB=html-keys,WW=1,IWT=0,ST=0,IN=1,WC=A-Za-z0-9_:$,LN=BBC,CF=1,');
  ExtensionSettings.setLangRefersTo('bbc', 'bbc');

  // TeX
  replace_def_data("def-language-tex",'MN=TeX,TABS=+4,MA=1 74 1,KEYTAB=default-keys,WW=1,IWT=0,ST=0,IN=1,WC=A-Za-z0-9_:$\\,LN=tex,CF=1,');
  ExtensionSettings.setLangRefersTo('tex', 'tex');

  // BibTeX
  replace_def_data("def-language-bibtex",'MN=BibTeX,TABS=+4,MA=1 74 1,KEYTAB=default-keys,WW=1,IWT=0,ST=0,IN=1,WC=A-Za-z0-9_:$\\,LN=BibTeX,CF=1,');
  ExtensionSettings.setLangRefersTo('bib', 'bibtex');

  // PDF
  replace_def_data("def-language-pdf",'MN=PDF,TABS=+4,MA=1 74 1,KEYTAB=default-keys,WW=1,IWT=0,ST=0,IN=1,WC=A-Za-z0-9_:$\\,LN=PDF,CF=1,');
  ExtensionSettings.setLangRefersTo('pdf', 'pdf');

  // Postscript
  replace_def_data("def-language-postscript",'MN=PostScript,TABS=+4,MA=1 74 1,KEYTAB=default-keys,WW=1,IWT=0,ST=0,IN=1,WC=A-Za-z0-9_:$\\,LN=PostScript,CF=1,');
  ExtensionSettings.setLangRefersTo('ps', 'postscript');

  // DTD
  replace_def_data("def-language-dtd",'MN=DTD,TABS=+4,MA=1 74 1,KEYTAB=xml-keys,WW=1,IWT=0,ST=0,IN=2,WC=A-Za-z0-9_:$?.!\-,LN=XMLDTD,CF=1,');
  ...
  // XML
  replace_def_data("def-language-xml",'MN=XML,TABS=+4,MA=1 74 1,KEYTAB=xml-keys,WW=1,IWT=0,ST=0,IN=2,WC=A-Za-z0-9_:$?.!\-,LN=XML,CF=1,');
  ...
  // JSP TagLib
  replace_def_data("def-language-tld",'MN=JSP TagLib,TABS=+4,MA=1 74 1,KEYTAB=html-keys,WW=1,IWT=0,ST=0,IN=1,WC=A-Za-z0-9_:$,LN=XMLTAGLIB,CF=1,');
  ...
  replace_def_data("def-language-bourneshell",'MN=Bourne Shell,TABS=+8,MA=1 74 1,KEYTAB=ext-keys,WW=1,IWT=0,ST=0,IN=2,WC=A-Za-z0-9_$,LN=Bourne Shell,CF=1,LNL=0,');
  ...
  // C Shell
  replace_def_data("def-language-csh",'MN=C Shell,TABS=+8,MA=1 74 1,KEYTAB=ext-keys,WW=1,IWT=0,ST=0,IN=2,WC=A-Za-z0-9_$,LN=C Shell,CF=1,LNL=0,');
  replace_def_data("def-options-csh",'4 1 1 0 0 3 0');
  ExtensionSettings.setLangRefersTo('csh', 'csh');

  // SlickEdit Color Coding files
  replace_def_data("def-language-vlx",'MN=SlickEdit Color Coding,TABS=+4,MA=1 74 1,KEYTAB=ext-keys,WW=1,IWT=0,ST=0,IN=1,WC=A-Za-z0-9_$,LN=vlx,CF=1,LNL=0,');
  replace_def_data("def-options-vlx",'4 1 1 0 0 3 0');
  ExtensionSettings.setLangRefersTo('vlx', 'vlx');

  // SlickEdit message file
  replace_def_data("def-language-vsm",'MN=SlickEdit Message File,TABS=+4,MA=1 74 1,KEYTAB=ext-keys,WW=1,IWT=0,ST=0,IN=1,WC=A-Za-z0-9_$,LN=vsm,CF=1,LNL=0,');
  ...
  // DB2
  replace_def_data("def-language-db2",'MN=DB2,TABS=+8,MA=1 74 1,KEYTAB=ext-keys,WW=1,IWT=0,ST=0,IN=2,WC=A-Za-z0-9_,LN=DB2,CF=1,LNL=0,');
  ...
  // JCL
  replace_def_data("def-language-jcl",'MN=JCL,TABS=+8,MA=1 74 1,KEYTAB=jcl-keys,WW=1,IWT=0,ST=0,IN=2,WC=A-Za-z0-9_$,LN=JCL,CF=1,LNL=0,TL=72');
  replace_def_data("def-options-jcl",'4 1 1 0 0 3 0');
  ExtensionSettings.setLangRefersTo('jcl', 'jcl');
  ExtensionSettings.setLangRefersTo('job', 'jcl');

  // Grep
  replace_def_data("def-language-grep",'MN=Grep,TABS=+4,MA=1 74 1,KEYTAB=grep-keys,WW=1,IWT=0,ST=0,IN=1,WC=A-Za-z0-9_$,LN=,CF=4,');
  ...
  replace_def_data("def-language-rc",'MN=Windows Resource File,TABS=+4,MA=1 74 1,KEYTAB=ext-keys,WW=1,IWT=0,ST=0,IN=1,WC=A-Za-z0-9_,LN=Windows Resource File,CF=1,');
  ExtensionSettings.setLangRefersTo('rc', 'rc');

  // Module Definition File
  replace_def_data("def-language-def",'MN=Module-Definition File,TABS=+4,MA=1 74 1,KEYTAB=ext-keys,WW=1,IWT=0,ST=0,IN=1,WC=A-Za-z0-9_,LN=Module-Definition File,CF=1,');
  ...
  _default_color(CFG_MODIFIED_FILE_TAB,0xFF,0xFFFFFF,0);

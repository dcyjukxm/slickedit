...
static TBCATLIST gToolbarCatTab[] = {
   ...
   { "Windowing",
      {
         { 'bbfullscreen.ico','fullscreen','Toggle Full Screen Editing Mode' },
         { 'bbcascade.ico','cascade-windows','Cascade Edit Windows' },
...
void _tbSetLastUnifiedToolbarState(int state)
{
   s_lastUnifiedToolbarState = state;
}

int _tbGetLastUnifiedToolbarState()
{
   return s_lastUnifiedToolbarState;
}

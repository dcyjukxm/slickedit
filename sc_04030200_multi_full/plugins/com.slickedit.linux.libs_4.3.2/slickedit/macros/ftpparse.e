...
//
// A JES listing (the info we want) looks like this:
//
// JOBNAME  JOBID    OWNER    STATUS CLASS
// AKLVPMBR JOB06504 AKLVPMB  OUTPUT A
// AKLVPMBR JOB06495 AKLVPMB  OUTPUT A
// AKLVPMBR JOB05518 AKLVPMB  OUTPUT A
// AKLVPMBR JOB05508 AKLVPMB  OUTPUT A
// AKLVPMB  TSU08083 AKLVPMB  ACTIVE TSU      
static int _ftpParseDir_MVS(FtpConnProfile* fcp_p, FtpDirectory& remote_dir, _str filter)
{
   ...
   if( !pos('^:i/:i/:i$',created,1,'er') ) {
      ...
      } else if (lowcase(volume_or_name)=="jobname") {
         jes=true;
         fcp_p->remoteDir.flags |= FTPDIRTYPE_MVS_VOLUME;
      }
   ...
   for(;;) {
      ...
      if( datasets ) {
         ...
         clazz="";
         jobname="";
         // using filename for jobid field because that is how these are opened
         parse line with jobname filename owner stat clazz rest; 
      } else {

...
static int GetItemFromVCXProj(_str vsproj_filename,_str config,_str item,_str &output)
{
   ...
   case 'OutputDirectory':
      index = _xmlcfg_find_simple(handle, "/Project/PropertyGroup/OutDir[@Condition=\"'$(Configuration)|$(Platform)'=='"config"'\"]");
      if (index < 0) {
      ...
      if ( ch=='P' ) {
         ...
         case 'W': {
               ...
               if (recursionMonitorHash != null && (*recursionMonitorHash):["%rw"] == 1) {
                  _message_box(nls(get_message(VSBUILDRC_INFINITE_LOOP_DETECTED_IN_COMMAND), "", "%rw"));
                  if (recursionStatus != null) {
                     *recursionStatus = -1;
                  }
                  return "";
         ...
         if (ch2=='P') {
            ...
            if (recursionMonitorHash != null && (*recursionMonitorHash):["%cp"] == 1) {
               _message_box(nls(get_message(VSBUILDRC_INFINITE_LOOP_DETECTED_IN_COMMAND), "", "%cp"));
               if (recursionStatus != null) {
                  *recursionStatus = -1;
               }
               return "";
         ...
         if (ch2 == 'R') {
            ...
            if (recursionMonitorHash != null && (*recursionMonitorHash):["%i"] == 1) {
               _message_box(nls(get_message(VSBUILDRC_INFINITE_LOOP_DETECTED_IN_COMMAND), "", "%i"));
               if (recursionStatus != null) {
                  *recursionStatus = -1;
               }
               return "";
            ...
            if (recursionMonitorHash != null && (*recursionMonitorHash):["%in"] == 1) {
               _message_box(nls(get_message(VSBUILDRC_INFINITE_LOOP_DETECTED_IN_COMMAND), "", "%in"));
               if (recursionStatus != null) {
                  *recursionStatus = -1;
               }
               return "";
         ...
         if (project_name != '') {
            ...
            if ( associatedProject!='' && _IsVisualStudioProjectFilename(associatedProject) ) {
               ...
               if (_isMac()) {
                  ...
                  if ( associatedProject!='' && _IsXcodeProjectFilename(associatedProject)) {
                     info=_xcode_get_output_file(project_name,associatedProject,config,absOutputDir);
                  } else {
            ...
            case 'N':
               ...
               len = 3;
               s = _strip_filename(absOutputDir, 'PE');
            ...
            case 'P':
               ...
               len = 3;
               s = _strip_filename(absOutputDir, 'N');
            ...
            if (ch3=='B') {
               ...
               if (ch4=='S') {
                  ...
                  if (recursionMonitorHash != null && (*recursionMonitorHash):["%libs"] == 1) {
                     _message_box(nls(get_message(VSBUILDRC_INFINITE_LOOP_DETECTED_IN_COMMAND), "", "%libs"));
                     if (recursionStatus != null) {
                        *recursionStatus = -1;
                     }
                     return "";
         ...
         if (k) {
            ...
            if (recursionMonitorHash != null && (*recursionMonitorHash):["%("envvar_name")"] == 1) {
               ...
               _message_box(nls(get_message(VSBUILDRC_INFINITE_LOOP_DETECTED_IN_COMMAND), "", "%(" envvar_name ")"));
               if (recursionStatus != null) {
                  *recursionStatus = -1;
               }
               return "";
         ...
         if (k) {
            ...
            if (recursionMonitorHash != null && (*recursionMonitorHash):["%["registry_path"]"] == 1) {
               //say("infinite loop detected: " envvar_name);
               _message_box(nls(get_message(VSBUILDRC_INFINITE_LOOP_DETECTED_IN_COMMAND), "", "%[" registry_path "]"));
               if (recursionStatus != null) {
                  *recursionStatus = -1;
               }
               return "";
...
#define CFG_EQUAL_STR 'CFG='
            ...
            case 'D':
               ...
               if (recursionMonitorHash != null && (*recursionMonitorHash):["%bd"] == 1) {
                  _message_box(nls(get_message(VSBUILDRC_INFINITE_LOOP_DETECTED_IN_COMMAND), "", "%bd"));
                  if (recursionStatus != null) {
                     *recursionStatus = -1;
                  }
                  return "";
            ...
            case 'O':
               ...
               if (recursionMonitorHash != null && (*recursionMonitorHash):["%bo"] == 1) {
                  _message_box(nls(get_message(VSBUILDRC_INFINITE_LOOP_DETECTED_IN_COMMAND), "", "%bo"));
                  if (recursionStatus != null) {
                     *recursionStatus = -1;
                  }
                  return "";
            ...
            case 'X':
               {
                  ...
                  if (ch3 == 'C') {
                     ...
                     if (recursionMonitorHash != null && (*recursionMonitorHash):["%bxc"] == 1) {
                        _message_box(nls(get_message(VSBUILDRC_INFINITE_LOOP_DETECTED_IN_COMMAND), "", "%bxc"));
                        if (recursionStatus != null) {
                           *recursionStatus = -1;
                        }
                        return "";
                     ...
                     if (recursionMonitorHash != null && (*recursionMonitorHash):["%bxt"] == 1) {
                        _message_box(nls(get_message(VSBUILDRC_INFINITE_LOOP_DETECTED_IN_COMMAND), "", "%bxt"));
                        if (recursionStatus != null) {
                           *recursionStatus = -1;
                        }
                        return "";
                     ...
                     if (recursionMonitorHash != null && (*recursionMonitorHash):["%bxk"] == 1) {
                        _message_box(nls(get_message(VSBUILDRC_INFINITE_LOOP_DETECTED_IN_COMMAND), "", "%bxk"));
                        if (recursionStatus != null) {
                           *recursionStatus = -1;
                        }
                        return "";
         ...
         if (ch2=='B') {
            ...
            if (ch3=='D') {
               ...
               if (recursionMonitorHash != null && (*recursionMonitorHash):["%jbd"] == 1) {
                  _message_box(nls(get_message(VSBUILDRC_INFINITE_LOOP_DETECTED_IN_COMMAND), "", "%jbd"));
                  if (recursionStatus != null) {
                     *recursionStatus = -1;
                  }
                  return "";
      ...
      if (recurseRepString && lastOption != "") {
         ...
         if (recursionMonitorHash != null) {
            ...
            s = _parse_project_command(s, buf_name, project_name, cword, argline,
                                       ToolName, ClassPath, &recLocalStatus, &recLocalHash);
            // clear the flag now that the recursion concerning this var is over

...
defload()
{
   ...
   _CreateLanguage(ANTLR_LANGUAGE_ID, ANTLR_MODE_NAME,
                   'MN='ANTLR_MODE_NAME',TABS=+3,MA=1 74 1,KEYTAB=c-keys,WW=1,IWT=0,ST=0,IN=2,WC='WORD_CHARS',LN='ANTLR_MODE_NAME',',
                   '',
                   '3 1 1 1 0 1 0',
                   '');
   ...
   _CreateLanguage(LEX_LANGUAGE_ID, LEX_MODE_NAME,
                   'MN='LEX_MODE_NAME',TABS=+3,MA=1 74 1,KEYTAB=c-keys,WW=1,IWT=0,ST=0,IN=2,WC='WORD_CHARS',LN='LEX_MODE_NAME',',
                   '0 lex *',
                   '3 1 1 1 0 1 0',
                   '');
   ...
   _CreateLanguage(YACC_LANGUAGE_ID, YACC_MODE_NAME,
                   'MN='YACC_MODE_NAME',TABS=+3,MA=1 74 1,KEYTAB=c-keys,WW=1,IWT=0,ST=0,IN=2,WC='WORD_CHARS',LN='YACC_MODE_NAME',',
                   '0 yacc *',
                   '3 1 1 1 0 1 0',
                   '');

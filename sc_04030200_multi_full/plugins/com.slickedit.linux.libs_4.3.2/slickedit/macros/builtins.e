 ...
 *
 */
int window_match(_str name_prefix,int find_first,_str options="");
 ...
 *    <DT>'F'<DD>Sort filenames
 *    <DT>'N'<DD>Sort numbers
 *    <DT>'E'<DD>Exact Case.  Sort is case insensitive if this option is not specified.

...
// private static _str buildStyles(int styleFlags, _str &vcsProject)
// {
//    styles := '';
//    if (styleFlags & VCS_ERROR_STDERR_STDOUT) {
//       styles = 'error_redir';
//    } else if (styleFlags & VCS_ERROR_STDOUT) {
//       styles = 'error_stdout';
//    } else if (styleFlags & VCS_ERROR_FILE) {
//       styles = 'error_file,sserror_file_rc';
//    } else if (styleFlags & VCS_ERROR_INTERNAL_LOOKUP) {
//       styles = 'internal_cmd_lookup';
//    }
//
//    if (styleFlags & VCS_DELTA_ERROR) styles :+= ',delta_error';
//    if (styleFlags & VCS_WRITE_COMMENT_TO_FILE) styles :+= ',comment_file';
//    if (styleFlags & VCS_UNIX_COMMENT_FILE) styles :+= ',unix_comment_file';
//    if (styleFlags & VCS_DOSRC_FOR_ERROR) styles :+= ',dosrc';
//    if (styleFlags & VCS_ARCHIVE_FILESPEC) styles :+= ',pvcs_wildcards';
//    if (styleFlags & VCS_PROJECT_REQUIRED) styles :+= ',vcp_required';
//    if (styleFlags & VCS_ALWAYS_SHOW_OUTPUT) styles :+= ',always_show_output';
//    if (styleFlags & VCS_CD_TO_FILE) styles :+= ',cdtofile';
//
//    if (styleFlags & VCS_PROJ_SS_TREE) {
//       styles :+= ',sstree';
//       vcsProject='ssproject,sswcl cd %s -o%t -exitcode';
//    } else if (styleFlags & VCS_PROJ_SS_ONE_DIR) {
//       styles :+= ',ssonedir';
//       vcsProject='ssproject,ss cd %s -o%t -exitcode';
//    } else if (styleFlags & VCS_PROJ_SS_LOCATE_FILE) {
//       styles :+= ',sslocate';
//    } else if (styleFlags & VCS_PROJ_CD_TO_DIR) {
//       vcsProject='dir';
//    }
//
//    return styles;
...
// private static boolean writeINI(_str filename)
// {
// say('writeINI(filename='filename' )');
//    // go through each provider and see if it has changed
//    _str providerName;
//    VersionControlProvider vcp;
//    int status = 1;
//    foreach (providerName => vcp in def_vc_providers) {
//       if (vcp.Modified) {
//
//          // now load this into a temp view
//          tempView := 0;
//          origView := _create_temp_view(tempView);
//
//          insert_line('name='vcp.Name);
//          // build the command list
//          _str commandKey;
//          CommandInfo commandInfo;
//          foreach (commandKey => commandInfo in g_commandInfo) {
//             if (vcp.Commands[commandInfo.Index] != null) {
//                insert_line(commandKey'='vcp.Commands[commandInfo.Index]);
//             }
//          }
//
//          // build the styles string and vcsProject info
//          styles := buildStyles(vcp.Styles, vcp.VCSProject);
//          insert_line('styles='vcp.Styles);
//          insert_line('vcsproject='vcp.VCSProject);
//
//          // replace!
//          p_window_id = origView;
//          status = status | _ini_put_section(filename, providerName, tempView);
//       }
//    }
//
//    return (status != 0);
...
// public static _str getAddCommand(_str provider)
// {
//    return getCommand(provider, VC_COMMAND_ADD);
// }
//
// public static void setAddCommand(_str provider, _str commandValue)
// {
//    setCommand(provider, VC_COMMAND_ADD, commandValue);
// }
//
// public static _str getCheckinCommand(_str provider)
// {
//    return getCommand(provider, VC_COMMAND_CHECKIN);
// }
//
// public static void setCheckinCommand(_str provider, _str commandValue)
// {
//    setCommand(provider, VC_COMMAND_CHECKIN, commandValue);
// }
//
// public static _str getCheckoutCommand(_str provider)
// {
//    return getCommand(provider, VC_COMMAND_CHECKOUT);
// }
//
// public static void setCheckoutCommand(_str provider, _str commandValue)
// {
//    setCommand(provider, VC_COMMAND_CHECKOUT, commandValue);
// }
//
// public static _str getDiffCommand(_str provider)
// {
//    return getCommand(provider, VC_COMMAND_DIFFERENCE);
// }
//
// public static void setDiffCommand(_str provider, _str commandValue)
// {
//    setCommand(provider, VC_COMMAND_DIFFERENCE, commandValue);
// }
//
// public static _str getGetCommand(_str provider)
// {
//    return getCommand(provider, VC_COMMAND_GET);
// }
//
// public static void setGetCommand(_str provider, _str commandValue)
// {
//    setCommand(provider, VC_COMMAND_GET, commandValue);
// }
//
// public static _str getHistoryCommand(_str provider)
// {
//    return getCommand(provider, VC_COMMAND_HISTORY);
// }
//
// public static void setHistoryCommand(_str provider, _str commandValue)
// {
//    setCommand(provider, VC_COMMAND_HISTORY, commandValue);
// }
//
// public static _str getLockCommand(_str provider)
// {
//    return getCommand(provider, VC_COMMAND_LOCK);
// }
//
// public static void setLockCommand(_str provider, _str commandValue)
// {
//    setCommand(provider, VC_COMMAND_LOCK, commandValue);
// }
//
// public static _str getManagerCommand(_str provider)
// {
//    return getCommand(provider, VC_COMMAND_MANAGER);
// }
//
// public static void setManagerCommand(_str provider, _str commandValue)
// {
//    setCommand(provider, VC_COMMAND_MANAGER, commandValue);
// }
//
// public static _str getPropertiesCommand(_str provider)
// {
//    return getCommand(provider, VC_COMMAND_PROPERTIES);
// }
//
// public static void setPropertiesCommand(_str provider, _str commandValue)
// {
//    setCommand(provider, VC_COMMAND_PROPERTIES, commandValue);
// }
//
// public static _str getRemoveCommand(_str provider)
// {
//    return getCommand(provider, VC_COMMAND_REMOVE);
// }
//
// public static void setRemoveCommand(_str provider, _str commandValue)
// {
//    setCommand(provider, VC_COMMAND_REMOVE, commandValue);
// }
//
// public static _str getUnlockCommand(_str provider)
// {
//    return getCommand(provider, VC_COMMAND_UNLOCK);
// }
//
// public static void setUnlockCommand(_str provider, _str commandValue)
// {
//    setCommand(provider, VC_COMMAND_UNLOCK, commandValue);
// }

 ...
 * @categories Tagging_Functions
 */
extern int tag_clear_context(_str file_name=null);
 ...
 * @param find_tag_below find the nearest context item <i>below</i> the current
 *                       line
 * 
 ...
 * @categories Tagging_Functions
 */
extern int tag_nearest_context(int linenum, int filter_flags=VS_TAGFILTER_ANYTHING, boolean find_tag_below=false);
 ...
 * @categories Tagging_Functions
 */
extern int tag_lock_matches(boolean doWrite=false);
/**

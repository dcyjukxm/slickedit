...
/**
 * Calls a Java method which takes a String argument and returns
 * an integer. The method is called through the JNI. 
 * 
 * @param methodName the name of the method
 * @param methodArgs the argument 
 * 
 * @return int the return value of the method
 */
extern int _eclipse_call_int_method(_str methodName, _str methodArgs);
/**
...
extern int _eclipse_preferences_updated();
#endif

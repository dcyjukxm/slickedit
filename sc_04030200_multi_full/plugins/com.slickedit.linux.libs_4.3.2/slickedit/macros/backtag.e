...
int RetagFile(_str filename, boolean useThread=false, int bufferId=0)
{
   if (useThread && RetagCurrentFileAsync(filename) == 0) {
      return 0;
   }
   boolean inmem=false;
   int temp_view_id=0;
...
int RetagCurrentFileAsync(_str buf_name)
{

...
_str def_pl1_include_extensions = ". .pl1 .pli .plm";
...
defload()
{
   _str setup_info='MN='PL1_MODE_NAME',TABS=+4,MA=1 74 1,':+
               'KEYTAB='PL1_LANGUAGE_ID'-keys,WW=1,IWT=0,ST=0,IN=2,WC='PL1_IDENTIFIER_CHARS',LN='PL1_VLXLEXERNAME',CF=1,';
   _str compile_info='';
 ...
 * @param indents indent values for each line (unused) 
 */
void _pl1_indent_surround(_str direction, int (&indents):[])
{
 ...
 * PL/I includes.
 */
_str get_pl1_include_extensions()
{
   return def_pl1_include_extensions;
}

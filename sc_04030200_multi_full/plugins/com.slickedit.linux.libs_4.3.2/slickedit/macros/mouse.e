 ...
 * 
 */ 
_command void page_right() name_info(','VSARG2_READ_ONLY|VSARG2_REQUIRES_EDITORCTL)
{
   int width;
 ...
 * 
 */ 
_command void page_left() name_info(','VSARG2_READ_ONLY|VSARG2_REQUIRES_EDITORCTL)
{
   int width;
   if (p_object!=OI_LIST_BOX && p_fixed_font) {

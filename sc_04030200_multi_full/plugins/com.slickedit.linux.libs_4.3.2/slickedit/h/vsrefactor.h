 ...
 */
extern int vsRefactorFileMessage(const char *filename, int i VSDEFAULT(1), int n VSDEFAULT(1));
 ...
 * @categories Refactoring_Functions
 */
extern int vsRefactorMessage(const char *message, bool isFilename VSDEFAULT(false));
 ...
 */
extern int vsRefactorLocateFile(int handle, const char* fileName,
 ...
 *         </ul>
 */
EXTERN_C int VSAPI vsRefactorPromptToSkip(int handle, const char *filename, int status);
 ...
 *
 */
EXTERN_C int VSAPI refactor_config_add(VSPSZ configName, VSPSZ configHeader, VSPSZ includePath);
 ...
 *
 */
EXTERN_C int VSAPI refactor_config_add_java(VSPSZ configName, VSPSZ sourcePath, VSPSZ jarPath);
 ...
 * @categories Refactoring_Functions
 */
EXTERN_C int VSAPI vsRefactorConfigAdd(const char * configName, const char * configHeader, const char * includePath);
 ...
 * @categories Refactoring_Functions
 */
EXTERN_C int VSAPI vsRefactorConfigJavaAdd(const char * configName, const char * sourcePath, const char * jarPath);
 ...
 * @categories Refactoring_Functions
 */
EXTERN_C int VSAPI vsRefactorConfigGetName(int configIndex, char * configName, int maxLength);
 ...
 * @categories Refactoring_Functions
 */
EXTERN_C int VSAPI vsRefactorConfigGetType(int configIndex, char * configType, int maxLength);
 ...
 * @categories Refactoring_Functions
 */
EXTERN_C int VSAPI vsRefactorConfigGetHeader(const char * configName, char * configHeader, int maxLength);
 ...
 * @categories Refactoring_Functions
 */
EXTERN_C int VSAPI vsRefactorConfigSetHeader(const char * configName, const char * configHeader);
 ...
 *
 */
EXTERN_C int VSAPI refactor_config_get_include(VSPSZ configName, int includeIndex, VSHREFVAR includePath);
 ...
 *
 */
EXTERN_C int VSAPI refactor_config_get_jar(VSPSZ configName, int jarIndex, VSHREFVAR jarPath);
 ...
 * @categories Refactoring_Functions
 */
EXTERN_C int VSAPI vsRefactorConfigGetInclude(const char * configName, int includeIndex, char *includePath, int maxLength);
 ...
 * @categories Refactoring_Functions
 */
EXTERN_C int VSAPI vsRefactorConfigGetJAR(const char * configName, int jarIndex, char *jarPath, int maxLength);
 ...
 *
 */
EXTERN_C int VSAPI refactor_config_add_include(VSPSZ configName, VSPSZ includePath, int includeIndex VSDEFAULT(-1));
 ...
 *
 */
EXTERN_C int VSAPI refactor_config_add_jar(VSPSZ configName, VSPSZ jarPath, int jarIndex VSDEFAULT(-1));
 ...
 * @categories Refactoring_Functions
 */
EXTERN_C int VSAPI vsRefactorConfigAddInclude(const char * configName, const char * includePath, int includeIndex VSDEFAULT(-1));
 ...
 * @categories Refactoring_Functions
 */
EXTERN_C int VSAPI vsRefactorConfigAddJAR(const char * configName, const char * jarPath, int jarIndex VSDEFAULT(-1));
 ...
 * @categories Refactoring_Functions
 */
EXTERN_C int VSAPI vsRefactorConfigDeleteInclude(const char * configName, const char * includePath);
 ...
 * @categories Refactoring_Functions
 */
EXTERN_C int VSAPI vsRefactorConfigDeleteJAR(const char * configName, const char * jarPath);
 ...
 * @categories Refactoring_Functions
 */
EXTERN_C int VSAPI vsRefactorCommitTransaction(const int handle);
 ...
 * @categories Refactoring_Functions
 */
EXTERN_C int VSAPI vsRefactorCancelTransaction(const int handle);
 ...
 *
 */
EXTERN_C int VSAPI refactor_add_file(int handle, VSPSZ filename,
                                     VSPSZ userIncludePath, VSPSZ systemIncludePath,
                                     VSPSZ defineOptions, VSPSZ compilerConfig);
 ...
 * @categories Refactoring_Functions
 */
EXTERN_C int VSAPI vsRefactorAddFile(const int handle, const char* filename,
   const char* userIncludePath, const char* systemIncludePath,
                                     const char* defineOptions, const char* compilerConfig);

EXTERN_C int VSAPI refactor_set_file_encoding(int handle, VSPSZ filename, VSPSZ encoding);
EXTERN_C int VSAPI refactor_get_file_encoding(int handle, VSPSZ filename, VSHREFVAR encoding);
 ...
 * @categories Refactoring_Functions
 */
EXTERN_C int VSAPI vsRefactorRemoveFile(const int handle, const char* filename);
 ...
 * @categories Refactoring_Functions
 */
EXTERN_C int VSAPI vsRefactorCountModifiedFiles(const int handle);
 ...
 *
 */
EXTERN_C int VSAPI refactor_get_modified_file_name(int handle, int index, VSHREFVAR filename);
 ...
 * @categories Refactoring_Functions
 */
EXTERN_C int VSAPI vsRefactorGetModifiedFileName(const int handle, const int index,
                                                 char* filename, const int maxLength);
 ...
 *
 */
EXTERN_C int VSAPI refactor_get_modified_file_contents(int wid, int handle, VSPSZ filename);
 ...
 * @categories Refactoring_Functions
 */
EXTERN_C int VSAPI vsRefactorGetModifiedFileContents(int wid, const int handle, const char* filename);
 ...
 *
 */
EXTERN_C int VSAPI refactor_set_modified_file_contents(int wid, int handle, VSPSZ filename);
 ...
 * @categories Refactoring_Functions
 */
EXTERN_C int VSAPI vsRefactorSetModifiedFileContents(int wid, const int handle, const char* filename);
 ...
 * @categories Refactoring_Functions
 */
EXTERN_C int VSAPI vsRefactorCountErrorFiles(const int handle);
 ...
 *
 */
EXTERN_C int VSAPI refactor_get_error_file_name(int handle, int index, VSHREFVAR filename);
 ...
 * @categories Refactoring_Functions
 */
EXTERN_C int VSAPI vsRefactorGetErrorFileName(const int handle, const int index,
                                              char* filename, const int maxLength);
 ...
 * @categories Refactoring_Functions
 */
EXTERN_C int VSAPI vsRefactorCountErrors(const int handle, const char* filename VSDEFAULT(NULL));
 ...
 *
 */
EXTERN_C int VSAPI refactor_get_error(int handle, VSPSZ filename, int errorIndex, VSHREFVAR errorString);
 ...
 * @categories Refactoring_Functions
 */
EXTERN_C int VSAPI vsRefactorGetError(const int handle,
                                      const char* filename, const int errorIndex,
                                      char* errorString, const int maxLength);
 ...
 * @return 0 on success, <0 on error
 */
EXTERN_C int VSAPI refactor_add_user_include_directory(int handle, VSPSZ filename, VSPSZ userIncludePath);
 ...
 * @return 0 on success, <0 on error
 */
EXTERN_C int VSAPI vsRefactorAddUserIncludeDirectory(const int handle, const char* filename, const char *userIncludePath);
 ...
 * @categories Refactoring_Functions
 */
EXTERN_C int VSAPI vsRefactorCParse(const int handle, const unsigned int flags);
 ...
 *
 */
EXTERN_C int VSAPI refactor_c_preprocess(int handle, int wid, int addLineMarkers=1);
 ...
 * @categories Refactoring_Functions
 */
EXTERN_C int VSAPI vsRefactorCPreprocess(const int handle, int wid, int addLineMarkers=1);
 ...
 * @return 0 on success, <0 on error
 */
EXTERN_C int VSAPI refactor_c_add_class_info( int handle, VSPSZ className, VSPSZ filename, int beginSeekPos, int endSeekPos );
 ...
 * @categories Refactoring_Functions
 */
EXTERN_C int VSAPI vsRefactorCAddClassInfo( const int handle, const char *className, const char *filename,
                                            const unsigned int beginSeekPos, const unsigned int endSeekPos );
 ...
 *
 */
EXTERN_C int VSAPI refactor_c_rename(int handle, VSPSZ filename, VSPSZ symbolName,
                                     int beginSeekPos, int endSeekPos, VSPSZ newName,
                                     int flags);
 ...
 * @categories Refactoring_Functions
 */
EXTERN_C int VSAPI vsRefactorCRename(const int handle, const char* filename, const char* symbolPath,
                        const unsigned int beginSeekPos, const unsigned int endSeekPos,
                        const char* newName, const unsigned int flags);
 ...
 *
 */
EXTERN_C int VSAPI refactor_c_extract_method(int handle, VSPSZ filename,
                                             VSPSZ symbolName, VSHREFINT createCall,
                                             int beginSeekPos, int endSeekPos,
                                             VSHREFSTR returnType, VSHREFSTR paramInfo,
 ...
 * @categories Refactoring_Functions
 */
EXTERN_C int VSAPI vsRefactorCExtractMethod(const int handle, const char* filename,
                                            const char* symbolName, int &createMethodCall,
                                            const unsigned int beginSeekPos, const unsigned int endSeekPos,
                                            char* returnType, const unsigned int returnTypeMaxLength,
                                            char* paramInfo, const unsigned int paramInfoMaxLength,
                                            const unsigned int flags, const unsigned int syntaxIndent);
 ...
 *
 */
EXTERN_C int VSAPI refactor_c_extract_method_finish(int handle, VSPSZ filename,
                                                    VSPSZ newName, int createMethodCall,
                                                    VSPSZ paramInfo, VSPSZ commentInfo,
                                                    const unsigned int flags, int syntaxIndent);
 ...
 * @categories Refactoring_Functions
 */
EXTERN_C int VSAPI vsCRefactorCExtractMethodFinish(int handle, const char *filename,
                                                   const char* newName, int createMethodCall,
                                                   const char* paramInfo, const char* commentInfo,
                                                   int flags, int syntaxIndent);
 ...
 *
 */
EXTERN_C int VSAPI refactor_c_encapsulate(int handle, VSPSZ filename, VSPSZ symbolName, VSPSZ getterName, VSPSZ setterName,
                          VSPSZ methodName,
                          const unsigned int beginSeekPos, const unsigned int endSeekPos, int formattingFlags, int syntaxIndent );
 ...
 * @categories Refactoring_Functions
 */
EXTERN_C int VSAPI vsRefactorCEncapsulate(const int handle, const char* filename, const char* symbolName, const char *getterName,
            const char *setterName, const char *methodName, const unsigned int beginSeekPos,
            const unsigned int endSeekPos, int formattingFlags, int syntaxIndent );
 ...
 *
 */
EXTERN_C int VSAPI refactor_c_move_field(int handle, VSPSZ filename, VSPSZ symbolName, VSPSZ className, VSPSZ classFileName, VSPSZ classDefFileName,
                                          const unsigned int beginSeekPos, const unsigned int endSeekPos);
 ...
 * @categories Refactoring_Functions
 */
EXTERN_C int VSAPI vsRefactorCMoveField(const int handle, const char* filename, const char* symbolName, const char *className,
                         const char *classFileName, const char *classDefFileName, const unsigned int beginSeekPos, const unsigned int endSeekPos);
 ...
 *
 */
EXTERN_C int VSAPI refactor_c_replace_literal(int handle, VSPSZ filename, VSPSZ literalName, VSPSZ constantName, int flags);
 ...
 * @categories Refactoring_Functions
 */
EXTERN_C int VSAPI vsRefactorCReplaceLiteral(const int handle, const char* filename, const char* literalName,
                                     const char* constantName, const unsigned int flags);
...
* @categories Refactoring_Functions
*/
EXTERN_C int VSAPI vsRefactorCStandardMethods(const int handle, const char* filename, const char* symbolName,
                                              int startSeekPos, int endSeekPos, char** className, int &existingClassMethods );
...
EXTERN_C int VSAPI refactor_c_standard_methods(int handle, VSPSZ filename, VSPSZ symbolName,
                                               int startSeekPos, int endSeekPos, VSHREFSTR className, VSHREFINT existingClassMethods );
 ...
 * @categories Refactoring_Functions
 */
EXTERN_C int VSAPI vsRefactorCStandardMethodsFinish(int handle, const char*  filename, const char*  symbolName,
                     int startSeekPos, int endSeekPos, int methodsToCreate, int formattingFlags, int syntaxIndent);
 ...
 *
 */
EXTERN_C int VSAPI refactor_c_standard_methods_finish(int handle, VSPSZ filename, VSPSZ symbolName,
                      int startSeekPos, int endSeekPos, int methodsToCreate, int formattingFlags, int syntaxIndent);
 ...
 * @categories Refactoring_Functions
 */
EXTERN_C int VSAPI vsRefactorCModifyParamsGetInfo(int handle, const char *symbolName,
                                                  const char *filename, int beginSeekPos, int endSeekPos,
                                                  char *paramInfo);
 ...
 *
 */
EXTERN_C int VSAPI refactor_c_modify_params_get_info(int handle, VSPSZ symbolName,
                                                    VSPSZ filename, int beginSeekPos, int endSeekPos,
                                                    VSHREFVAR paramInfo);
 ...
 * @categories Refactoring_Functions
 */
EXTERN_C int VSAPI vsRefactorCModifyParams(int handle, const char *symbolName,
                                                  const char *filename, int beginSeekPos, int endSeekPos,
                                                  const char *oldParamInfo, const char *newParamInfo);
 ...
 *
 */
EXTERN_C int VSAPI refactor_c_modify_params(int handle, VSPSZ symbolName,
                                                    VSPSZ filename, int beginSeekPos, int endSeekPos,
                                                    VSPSZ oldParamInfo,VSPSZ newParamInfo);
 ...
 * @categories Refactoring_Functions
 */
EXTERN_C int VSAPI vsRefactorCGetSuperClasses(const int handle, const char* symbolName, const char* filename,
                           const unsigned int beginSeekPos, const unsigned int endSeekPos, 
                           char *superClassInfo);
 ...
 *
 */
EXTERN_C int VSAPI refactor_c_get_super_classes(int handle, VSPSZ className, VSPSZ filename,
                                     int beginSeekPos, int endSeekPos, VSHREFVAR superClasses);
/**
 ...
 * @categories Refactoring_Functions
 */
EXTERN_C int VSAPI vsRefactorCPullUp(const int handle, const char* filename, const char* className,
                                     const unsigned int beginSeekPos, const unsigned int endSeekPos, 
                                     const char* superClass, const char* membersToMove, 
                                     char* memberWorkingOn, const char* superClassDefFilename);
 ...
 *
 */
EXTERN_C int VSAPI refactor_c_pull_up(int handle, VSPSZ filename, VSPSZ className,
                                     int beginSeekPos, int endSeekPos, VSPSZ superClass, 
                                      VSPSZ membersToMove, VSHREFVAR memberWorkingOn,
 ...
 * @categories Refactoring_Functions
 */
EXTERN_C int VSAPI vsRefactorCPullUpFindMembers(const int handle, const char* filename, const char* symbolName,
                                     const unsigned int beginSeekPos, const unsigned int endSeekPos,
                                     const char* destClassName, char *members, const char* dependencyFiles);
 ...
 *
 */
EXTERN_C int VSAPI refactor_c_pull_up_find_members(int handle, VSPSZ filename, VSPSZ className,
                                     int beginSeekPos, int endSeekPos, VSPSZ destClassName, 
                                    VSHREFVAR members, VSPSZ dependencyFiles);
 ...
 * @categories Refactoring_Functions
 */
EXTERN_C int VSAPI vsRefactorCPushDown(const int handle, const char* filename, const char* className,
                                     const unsigned int beginSeekPos, const unsigned int endSeekPos, 
                                     const char* derivedClass, const char* membersToMove, 
                                     char* memberWorkingOn, 
                                     const char* classDefInfoList, const char *origClassDefFiles);
 ...
 *
 */
EXTERN_C int VSAPI refactor_c_push_down(int handle, VSPSZ filename, VSPSZ className,
                                     int beginSeekPos, int endSeekPos, VSPSZ derivedClass, 
                                      VSPSZ membersToMove, VSHREFVAR memberWorkingOn,
                                      VSPSZ classDefInfoList, VSPSZ origClassDefFiles);
 ...
 * @categories Refactoring_Functions
 */
EXTERN_C int VSAPI vsRefactorCPushDownFindMembers(const int handle, const char* filename, const char* symbolName,
                                     const unsigned int beginSeekPos, const unsigned int endSeekPos,
                                     const char* destClassName, char *members, const char* dependencyFiles);
 ...
 *
 */
EXTERN_C int VSAPI refactor_c_push_down_find_members(int handle, VSPSZ filename, VSPSZ className,
                                     int beginSeekPos, int endSeekPos, VSPSZ destClassName, 
                                    VSHREFVAR members, VSPSZ dependencyFiles);
 ...
 * @categories Refactoring_Functions
 */
EXTERN_C int VSAPI vsRefactorCPushDownFindClassInFile(const int handle, const char* className, 
                                                      const char* filename, int &foundClass);
 ...
 * 
 */
EXTERN_C int VSAPI refactor_c_push_down_find_class_in_file(int handle, VSPSZ className, VSPSZ filename, VSHREFVAR found);

/** 
 * Utility Functions for SlickEdit Tools
 */ 
EXTERN_C void VSAPI vsRefactorSetOutputCB(void (VSAPI *callback)(char*));
EXTERN_C void VSAPI vsRefactorOutput(char* szText);

...
EXTERN_C_BEGIN
   ...
   */
    ...
    * 
    */ 
   int VSAPI vsBPMAdd(int wid,int RealLineNum,int flags,void *puserdata VSDEFAULT(0));
   /**
    * 
    * @deprecated Use vsLineMarker* functions
    * 
    ...
    * 
    */ 
   int VSAPI vsBPMAddB(const char *pszBufName,int LineNum,int flags,void *puserdata VSDEFAULT(0));
   int VSAPI vsBPMAddDeferedBreakPoint(int LineNum,int NofLines,const char *pszBufName,int flags,int mask,int autoadd,int alwaysAddNewBreakPoint,void *pUserData,int BMIndex,int type,const char *pszMessage,int oldAPI,int markid,long BeginLineROffset,const char *pszLineData,int col);
   /**
    * 
    * @deprecated Use vsLineMarker* functions
    * 
    ...
    * 
    */ 
   int VSAPI vsBPMGet(int BreakPointIndex,int *pRealLineNum VSDEFAULT(0),int *pflags VSDEFAULT(0),void **ppuserdata VSDEFAULT(0),int *pBufID VSDEFAULT(0),void *preserved1 VSDEFAULT(0),void *preserved2 VSDEFAULT(0));
   /**
    * 
    * @deprecated Use vsLineMarker* functions
    * 
    ...
    * 
    */ 
   int VSAPI vsBPMQDefaultPicture(int wid,int LineNum,int RealLineNum,int OldLineNum,int reserved VSDEFAULT(0));
   /**
    * 
    * @deprecated Use vsLineMarker* functions
    * 
...
/********************************************************************************************/
 ...
 // do not use these functions.
   ...
   int VSAPI vsBPMSet2(int wid,int LineNum,int flags,int mask,int autoadd VSDEFAULT(1));
   int VSAPI vsBPMSetBL(const char *pszBufName,int LineNum,int flags,int mask,int autoadd);
   int VSAPI vsBPMQFlags(int wid);
   int VSAPI vsBPMQFlags2(int wid,int LineNum VSDEFAULT( -1));
   ...
   int VSAPI vsBPMEnumerate(int wid,int i,int *pFlags,int *pLineNum,void *pReserved VSDEFAULT(0));
   int VSAPI vsBPMEnumerateB(const char *pszBufName,int i,int *pFlags,int *pLineNum,void *pReserved VSDEFAULT(0));

   inline int VSAPI vsBPMSetBreakPoint(int wid,int LineNum VSDEFAULT(-1)) {return(vsBPMSet2(wid,LineNum,VSBPFLAG_BREAKPOINT,VSBPFLAG_BREAKPOINT));}
   inline int VSAPI vsBPMSetBreakPointBL(const char *pszBufName,int LineNum) {return(vsBPMSetBL(pszBufName,LineNum,VSBPFLAG_BREAKPOINT,VSBPFLAG_BREAKPOINT|VSBPFLAG_BREAKPOINTDISABLED,1));}
   inline void VSAPI vsBPMRemoveBreakPoint(int wid,int LineNum VSDEFAULT(-1)) {vsBPMSet2(wid,LineNum,0,VSBPFLAG_BREAKPOINT|VSBPFLAG_BREAKPOINTDISABLED,0);}
   inline void VSAPI vsBPMRemoveBreakPointBL(const char *pszBufName,int LineNum) {vsBPMSetBL(pszBufName,LineNum,0,VSBPFLAG_BREAKPOINT|VSBPFLAG_BREAKPOINTDISABLED,0);}
   inline int VSAPI vsBPMDisableBreakPoint(int wid,int LineNum VSDEFAULT(-1)) {return(vsBPMSet2(wid,LineNum,VSBPFLAG_BREAKPOINTDISABLED,VSBPFLAG_BREAKPOINT|VSBPFLAG_BREAKPOINTDISABLED,1));}
   inline int VSAPI vsBPMDisableBreakPointBL(const char *pszBufName,int LineNum) {return(vsBPMSetBL(pszBufName,LineNum,VSBPFLAG_BREAKPOINTDISABLED,VSBPFLAG_BREAKPOINT|VSBPFLAG_BREAKPOINTDISABLED,1));}
   inline int VSAPI vsBPMRemoveDisableBreakPoint(int wid,int LineNum VSDEFAULT(-1)) {return(vsBPMSet2(wid,LineNum,0,VSBPFLAG_BREAKPOINTDISABLED,0));}
   inline int VSAPI vsBPMRemoveDisableBreakPointBL(const char *pszBufName,int LineNum) {return(vsBPMSetBL(pszBufName,LineNum,0,VSBPFLAG_BREAKPOINTDISABLED,0));}

   inline int VSAPI vsBPMToggleBreakPoint(int wid,int LineNum VSDEFAULT(-1)) {
      int status;
   ...
   inline int VSAPI vsBPMSetExecLineBL(const char *pszBufName,int LineNum) {return(vsBPMSetBL(pszBufName,LineNum,VSBPFLAG_EXEC,VSBPFLAG_EXEC,1));}
   inline int VSAPI vsBPMSetExecLine(int wid,int LineNum VSDEFAULT( -1)) {return(vsBPMSet2(wid,LineNum,VSBPFLAG_EXEC,VSBPFLAG_EXEC,1));}
   inline void VSAPI vsBPMRemoveExecLineBL(const char *pszBufName,int LineNum) {vsBPMSetBL(pszBufName,LineNum,0,VSBPFLAG_EXEC,0);}
   inline void VSAPI vsBPMRemoveExecLine(int wid,int LineNum VSDEFAULT(-1)) {vsBPMSet2(wid,LineNum,0,VSBPFLAG_EXEC,0);}

   inline int VSAPI vsBPMSetStackExecLineBL(const char *pszBufName,int LineNum) {return(vsBPMSetBL(pszBufName,LineNum,VSBPFLAG_STACKEXEC,VSBPFLAG_STACKEXEC,1));}
   inline int VSAPI vsBPMSetStackExecLine(int wid,int LineNum VSDEFAULT(-1)) {return(vsBPMSet2(wid,LineNum,VSBPFLAG_STACKEXEC,VSBPFLAG_STACKEXEC,1));}
   inline void VSAPI vsBPMRemoveStackExecLineBL(const char *pszBufName,int LineNum) {vsBPMSetBL(pszBufName,LineNum,0,VSBPFLAG_STACKEXEC,0);}
   inline void VSAPI vsBPMRemoveStackExecLine(int wid,int LineNum VSDEFAULT(-1)) {vsBPMSet2(wid,LineNum,0,VSBPFLAG_STACKEXEC,0);}
/********************************************************************************************/
